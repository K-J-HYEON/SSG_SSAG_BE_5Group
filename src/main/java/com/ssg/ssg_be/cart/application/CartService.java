...
public interface CartService {
    boolean createCart(CartDtoReq cartDtoReq) throws BaseException;
    ...
    CartOptionPatchDtoRes updateCartOption(CartOptionPatchDtoReq cartOptionPatchDtoReq) throws BaseException;
}
