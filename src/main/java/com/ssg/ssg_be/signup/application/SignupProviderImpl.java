...
@Service
public class SignupProviderImpl {

    private final UserRepository userRepository;
    private final MarketingRepository marketingRepository;
    private final SellerRepository sellerRepository;

    public SignupProviderImpl(UserRepository userRepository, MarketingRepository marketingRepository, SellerRepository sellerRepository) {
